      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-blue-400">TechStore</h3>
            <p className="text-slate-300 text-sm">
              Cửa hàng công nghệ hàng đầu Việt Nam, chuyên cung cấp laptop, điện thoại và phụ kiện chính hãng với giá
              tốt nhất.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/laptops" className="text-slate-300 hover:text-white transition-colors">
                  Laptop
                </Link>
              </li>
              <li>
                <Link href="/phones" className="text-slate-300 hover:text-white transition-colors">
                  Điện thoại
                </Link>
              </li>
              <li>
                <Link href="/accessories" className="text-slate-300 hover:text-white transition-colors">
                  Phụ kiện
                </Link>
              </li>
              <li>
